  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.challengeTitleContainer}>
        <Text style={styles.challengeTitle}>CONSUMO CONSCIENTE POR 30 DIAS</Text>
      </View>

      {/* Imagem do Desafio */}
      <Image source={require('../assets/desafio2.png')} style={styles.challengeImage} />

      {/* Descrição */}
      <View style={styles.descriptionContainer}>
        <Text style={styles.description}>
          Este desafio incentiva a prática de um consumo mais consciente, avaliando a necessidade real de cada compra e escolhendo opções sustentáveis.
        </Text>
      </View>
      ...
      <View style={styles.tipsContainer}>
        ...
        <View style={styles.tip}>
          ...
          <Text style={styles.tipText}>Antes de comprar, pergunte-se: "Eu realmente preciso disso?"</Text>
        </View>
        <View style={styles.tip}>
          <Text style={styles.bulletPoint}>•</Text>
          <Text style={styles.tipText}>Pesquise marcas sustentáveis e que adotam práticas éticas.</Text>
        </View>
         <View style={styles.tip}>
          <Text style={styles.bulletPoint}>•</Text>
          <Text style={styles.tipText}>Crie uma lista de compras para evitar compras por impulso.</Text>
        </View>
      </View>
      ...
      <View style={styles.tipsContainer}>
        ...
        <Text style={styles.tipText}>Uma EcoBag com a logo da empresa</Text>
      </View>
