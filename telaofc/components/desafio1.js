...
const DesafioSemanaSemPlastico = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.challengeTitleContainer}>
        <Text style={styles.challengeTitle}>UMA SEMANA SEM PLÁSTICO</Text>
      </View>

      {/* Imagem do Desafio */}
      <Image source={require('../assets/desafio1.png')} style={styles.challengeImage} />

      {/* Descrição */}
      <View style={styles.descriptionContainer}>
        <Text style={styles.description}>
          Desafie-se a viver sem plásticos descartáveis por uma semana! Descubra novas alternativas e como isso pode impactar positivamente o meio ambiente.
        </Text>
      </View>
      ...
      <View style={styles.tipsContainer}>
        ...
        <View style={styles.tip}>
          ...
          <Text style={styles.tipText}>Substitua sacolas plásticas por bolsas reutilizáveis.</Text>
        </View>
        <View style={styles.tip}>
          <Text style={styles.bulletPoint}>•</Text>
          <Text style={styles.tipText}>Utilize frascos de vidro para armazenar alimentos e bebidas.</Text>
        </View>
      </View>
...
export default DesafioSemanaSemPlastico;
